...
const allNavItems: NavItem[] = [
  ...
  { title: "Carpenters", href: "/carpenters", icon: Hammer, roles: ["owner", "manager", "sales"] },
  { title: "Follow-up Surveys", href: "/follow-up-surveys", icon: ClipboardCheck, roles: ["owner", "manager", "sales"] },
