...
router.get('/success', payFastSuccessEnhancedController.handlePaymentSuccess.bind(payFastSuccessEnhancedController));
router.post('/success', payFastSuccessEnhancedController.handlePaymentSuccess.bind(payFastSuccessEnhancedController));
