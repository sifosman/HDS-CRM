    ...
    try {
        ...
        if (pfData.payment_status === 'COMPLETE') {
            try {
                ...
                res.status(500).json({
                    success: false,
                    error: 'Email sending failed: ' + ((emailError === null || emailError === void 0 ? void 0 : emailError.message) || 'Unknown error')
                });
            }
        }
        else {
