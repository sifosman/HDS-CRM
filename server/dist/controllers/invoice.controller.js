...
const downloadInvoice = async (req, res) => {
    try {
        ...
        const branchResult = await supabase_service_1.default.getBranchByTradingAs(branchTradingAs);
        if (branchResult.success && branchResult.data) {
            ...
            const bankingResult = await supabase_service_1.default.getBankingDetailsByBranch(branchTradingAs);
